...
Today's workshop is **NOT** something you will do typically, but is a way to build some intuition around why the inferential statistics we use all the time work. 

```{r openLibraries}
# install googlesheets4 for this workshop
