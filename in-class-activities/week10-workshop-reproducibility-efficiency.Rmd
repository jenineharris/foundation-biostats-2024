...
This paragraph might talk about about the process and statistical methods used. What happened during data management (recoding, missing value handling), which descriptive statistics and statistical tests were used, what assumptions were checked. Here is where you would cite all the R packages you used to do these analyses.
